...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <SectionHeader number="01" title="ABOUT" ext="md" />
      <div className="grid md:grid-cols-5 gap-12">
        ...
        >
          <p className="text-lg leading-relaxed text-foreground/90">
            <span className="text-primary text-4xl font-body font-bold float-left mr-3 mt-1 leading-none">H</span>
            ello! I'm <CursorGradientText className="font-bold">Krishna Kowshik</CursorGradientText>, an aspiring Software Developer skilled in Full Stack Development and Generative AI. I aim to leverage AI-driven technologies and modern web frameworks to develop innovative and impactful applications. Currently pursuing B.Tech in CSE (Data Science) at MVGR College of Engineering, Vizianagaram with a CGPA of 8.91.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          {stats.map((s) => (
            ...
            >
              <div className="font-body text-2xl font-bold text-primary">
