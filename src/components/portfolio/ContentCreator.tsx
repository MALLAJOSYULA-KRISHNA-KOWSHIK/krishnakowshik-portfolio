...
const ContentCreator = () => {
  ...
  return (
    <section id="creator" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <SectionHeader number="06" title="CONTENT_CREATOR" ext="yml" />
      <motion.div
        ref={ref}
      ...
      >
        <motion.div
          variants={slideLeft}
          className="bg-card border border-primary/10 rounded-2xl overflow-hidden"
        ...
        >
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-body text-foreground font-semibold">@koushiktales</h3>
                <p className="font-body text-xs text-muted-foreground">YouTube Channel</p>
              </div>
            </div>
            ...
            <a
              ...
              className="inline-block font-body text-sm px-4 py-2 border border-[hsl(0,100%,50%)]/30 text-[hsl(0,100%,50%)] hover:bg-[hsl(0,100%,50%)]/10 transition-colors rounded-2xl"
            >
              Visit Channel →
            </a>
          </div>
        ...
        >
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-body text-foreground font-semibold">Community Roles</h3>
                <p className="font-body text-xs text-muted-foreground">Leadership & Ambassadorship</p>
              </div>
            </div>
