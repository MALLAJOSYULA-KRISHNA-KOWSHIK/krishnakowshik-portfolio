...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
      <SectionHeader number="07" title="CONTACT" ext="sh" />
      <motion.div
        ref={ref}
        initial="hidden"
        ...
        className="space-y-6"
      >
        <h2 className="font-body text-3xl sm:text-5xl font-bold text-foreground inline-flex flex-wrap justify-center gap-0">
        ...
        <motion.button
          onClick={copyEmail}
          variants={scaleIn}
          className="font-body text-primary text-lg hover:text-glow-cyan inline-flex items-center gap-2 group transition-colors"
        ...
        >
          {socials.map((s, idx) => (
            <motion.a
              ...
              className="border border-primary/20 flex items-center justify-center text-muted-foreground transition-all rounded-2xl p-4"
