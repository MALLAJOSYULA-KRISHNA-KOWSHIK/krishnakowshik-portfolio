...
const experience: TimelineItem[] = [
  { title: "AI and ML Intern", subtitle: "JNTU-Hyderabad", detail: "During the course of this internship, I contributed my work for DST-NGP 2025 sponsored project titled: UrbanVision - Leveraging Drone-Based Computer Vision and Geospatial Technologies for Structural Health Monitoring of Bridges and Urban Infrastructure. I specifically executed my contribution in Design, Training, and Optimization of Machine Learning Models for Infrastructure Anomaly Detection." },
...
const certifications: TimelineItem[] = [
  { title: "Introduction to Generative AI", subtitle: "Google" },
  ...
  return (
    ...
    >
      ...
      <div className="bg-card border border-primary/10 rounded-2xl p-4">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {item.active && (
            <motion.span
              ...
              className="font-body text-[10px] px-2 py-0.5 bg-green/10 text-green rounded-2xl flex items-center gap-1"
            >
        ...
        {item.detail && <p className="text-xs text-primary mt-1 font-body">{item.detail}</p>}
      </div>
    </motion.div>
  );
};
...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <SectionHeader number="05" title="EXPERIENCE" ext="log" />
